...
/**MMmod MG*/
/** NEEDED: possible cases for MG parametrization*/
//enum mg_possible_ansatzes {mugamma, horndeski, mgtanh, omegade, cpl};
...
struct background
{
  ...
  /**MMmod MG*/
  /**NEEDED: include additional parameters for other parametrizations*/

  //General MG switch
  int use_MG;

  // Redshift at which modified gravity evolution should be switched on
  double mg_z_init;
