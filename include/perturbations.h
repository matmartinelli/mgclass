...
struct perturb_workspace
{
  ...
  int index_mt_psi_prime;     /**MMmod MG */
  ...
  /**MMmod MG*/
  int index_mt_MGmu;          /**< mu(a,k) MG function */
  int index_mt_MGmudot;       /**< \dot{mu}(a,k)  */
  int index_mt_MGeta;         /**< eta(a,k) MG function */
  int index_mt_MGetadot;      /**< \dot{eta}(a,k)  */
  int index_mt_A_MG;          /**< A_MG function */
